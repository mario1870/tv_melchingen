          ...
          <div className="pt-24 md:pt-24 min-h-screen px-2">
            ...
            <div className='w-full md:px-40 xl:px-60 2xl:px-[25rem] flex flex-col justify-center items-center py-8 '>
              ...
              <form onSubmit={handleSubmit} className='w-full flex flex-col gap-4'>
                ...
                {state.succeeded && <p className='text-gray-700 bg-green-400 mx-auto px-4 py-2 rounded-full text-center'>Formular erfolgreich übermittelt. Wir melden uns bei ihnen.</p>}
              </form>
            </div>
          </div>
        </>

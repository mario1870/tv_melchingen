...
const Roundnet = () => {
    const delayRectangle = 0.1

    return (
        <>
            <div className="min-h-svh z-10 flex justify-center items-center pt-32">
                <>
                    <motion.div
            ...
            <div className="pb-16 md:pb-40 pt-6 md:pt-32 placeholder-neutral-200 mx-4 md:mx-32 flex flex-col-reverse md:flex-row">
                ...
                <div className="rounded-xl md:w-1/2 px-4">
                    <img src="/roundnet/team.jpg" className="w-full max-w-[40rem] rounded-xl" />
                </div>
                
                
                    <div className="md:w-1/2 mb-6 px-4">
                        <h2 className="text-black text-2xl md:text-3xl font-bold font-freeman">Melchinger Goldhähnchen</h2>
